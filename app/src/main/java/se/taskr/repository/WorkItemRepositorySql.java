...
import se.taskr.sql.TaskRDbHelper;
import se.taskr.sql.TaskRDbContract.UsersEntry;
import se.taskr.sql.TaskRDbContract.WorkItemsEntry;
import se.taskr.sql.TaskRDbContract.UserWorkItemEntry;
...
class WorkItemRepositorySql implements WorkItemRepository {
    ...
    public void removeWorkItem(WorkItem workItem) {
        Log.d("To Delete: ", workItem.toString());
